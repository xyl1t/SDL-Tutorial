...
;return n.name="C",n.aliases=["c","h"],n}})());hljs.registerLanguage("cmake",(()=>{"use strict";return e=>({name:"CMake",
...
},e.HASH_COMMENT_MODE,e.QUOTE_STRING_MODE,e.NUMBER_MODE]})})());hljs.registerLanguage("x86asm",(()=>{"use strict";return s=>({
...
className:"meta",begin:/^\s*\.[\w_-]+/}]})})());hljs.registerLanguage("css",(()=>{"use strict";return e=>{
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},b]}}})());hljs.registerLanguage("makefile",(()=>{"use strict";return e=>{const i={
...
end:/$/,keywords:{$pattern:/[\.\w]+/,"meta-keyword":".PHONY"}},r]}}})());hljs.registerLanguage("php-template",(()=>{"use strict";return n=>({
